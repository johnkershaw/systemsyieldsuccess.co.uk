<?php 
$file = ($_GET["file"] ? $_GET["file"] : "gif_1.htm"); 
...
<html>
	<head>
		...
		<meta name="Author" content="Alan Keffler"/>
		
		<meta name="Manager" content=""/>
		
		<meta name="Company" content=" Systemsys Ltd"/>

		<title>System Example</title>
		<script src="/example_files/frameset.js" type="text/jscript" language="jscript"></script>
...
var g_FileList = new  Array(
	new FileEntry (1, 0, "System", "vml_1.htm", "gif_1.htm"),
	new FileEntry (2, 13, "1 Sales &#38; Marketing", "vml_2.htm", "gif_2.htm"),
 
	new FileEntry (3, 14, "2 Strategic Management", "vml_3.htm", "gif_3.htm"),
 
	new FileEntry (4, 8, "3 System", "vml_4.htm", "gif_4.htm"),
 
	new FileEntry (5, 6, "4 M&#38;I", "vml_5.htm", "gif_5.htm"),
 
	new FileEntry (6, 11, "5 CS", "vml_6.htm", "gif_6.htm"),
 
	new FileEntry (7, 5, "6 NPI", "vml_7.htm", "gif_7.htm"),
 
	new FileEntry (8, 15, "7 Supply Chain", "vml_8.htm", "gif_8.htm"),
 
	new FileEntry (9, 16, "8 Production", "vml_9.htm", "gif_9.htm"),
 
	new FileEntry (10, 12, "9 Dispatch", "vml_10.htm", "gif_10.htm"),
 
	new FileEntry (11, 9, "10 HR", "vml_11.htm", "gif_11.htm"),
 
	new FileEntry (12, 10, "11 Finance", "vml_12.htm", "gif_12.htm"),
 
	new FileEntry (13, 7, "12 IT", "vml_13.htm", "gif_13.htm"),
 
	new FileEntry (14, 4, "13 Production Services", "vml_14.htm", "gif_14.htm")

);

var g_CurPageIndex = <?= $page ?>;
...
function CreateHLObj (hlNode)
{
	...
	<frameset id="frmstOuter" cols="200,*" title="System">
		<frame src="/example_files/toolbar.htm" name="frmToolbar" id="frmToolbar" title="This frame contains tools for manipulating your drawing." frameborder="6" bordercolor="#999999" scrolling="no" marginheight="0" marginwidth="0" >
		<frame src="/example_files/<?= $file ?>" name="frmDrawing" title="This frame contains the pages of your drawing." marginheight="10" marginwidth="10" onload="if (parent.isUpLevel) FramePageLoaded()" >

		<noframes>
			<body>

				<h1>System Example</h1>
				<ul>								 
					<li><a href="/example_files/gif_1.htm">System</a></li>
					<li><a href="/example_files/gif_2.htm">1 Sales &#38; Marketing</a></li>
					<li><a href="/example_files/gif_3.htm">2 Strategic Management</a></li>
					<li><a href="/example_files/gif_4.htm">3 System</a></li>
					<li><a href="/example_files/gif_5.htm">4 M&#38;I</a></li>
					<li><a href="/example_files/gif_6.htm">5 CS</a></li>
					<li><a href="/example_files/gif_7.htm">6 NPI</a></li>
					<li><a href="/example_files/gif_8.htm">7 Supply Chain</a></li>
					<li><a href="/example_files/gif_9.htm">8 Production</a></li>
					<li><a href="/example_files/gif_10.htm">9 Dispatch</a></li>
					<li><a href="/example_files/gif_11.htm">10 HR</a></li>
					<li><a href="/example_files/gif_12.htm">11 Finance</a></li>
					<li><a href="/example_files/gif_13.htm">12 IT</a></li>
					<li><a href="/example_files/gif_14.htm">13 Production Services</a></li>
				</ul>
			</body>
		</noframes>
	</frameset>
